package io.th0rgal.oraxen.nms.v1_21_R1_spigot;
...
public class NMSHandler implements io.th0rgal.oraxen.nms.NMSHandler {
    ...
    public NMSHandler() {
        this.glyphHandler = new io.th0rgal.oraxen.nms.v1_21_R1_spigot.GlyphHandler();
        if (!warningLogged) {
            Logs.logWarning("Spigot 1.21.1 detected. Some features are limited compared to Paper.");
            Logs.logWarning("For full feature support, consider using Paper 1.21.1+");
            warningLogged = true;
        }
    }
