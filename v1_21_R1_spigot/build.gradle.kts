...
// This module is for Spigot servers, while v1_21_R1 is for Paper servers (Mojang-mapped)
// Requires: Run Spigot BuildTools for 1.21.1 to install artifacts to local Maven
