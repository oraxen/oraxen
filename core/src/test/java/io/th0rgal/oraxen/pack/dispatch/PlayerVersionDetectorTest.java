...
class PlayerVersionDetectorTest {
    ...
    void testProtocolToVersionString_1_21_4_andLater() {
        ...
        assertEquals("1.21.4+", PlayerVersionDetector.protocolToVersionString(770));
        assertEquals("1.21.4+", PlayerVersionDetector.protocolToVersionString(800));
        assertEquals("1.21.4+", PlayerVersionDetector.protocolToVersionString(999));
    }
    ...
    @Test
    void testProtocolToVersionString_1_20_1() {
        assertEquals("1.20.1", PlayerVersionDetector.protocolToVersionString(763));
    }
    ...
    void testProtocolToVersionString_UnknownVersions() {
        String result = PlayerVersionDetector.protocolToVersionString(757);
        assertTrue(result.startsWith("Unknown"), "Protocol 757 should return Unknown, got: " + result);

        result = PlayerVersionDetector.protocolToVersionString(100);
