 ...
 */
public class OraxenBlockDamageEvent extends Event implements Cancellable {
     ...
     */
    public OraxenBlockDamageEvent(@NotNull final CustomBlockMechanic mechanic, @NotNull final Block block, @NotNull final Player player) {
