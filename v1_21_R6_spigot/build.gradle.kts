...
// This module is for Spigot servers, while v1_21_R6 is for Paper servers (Mojang-mapped)
// Requires: Run Spigot BuildTools for 1.21.11 to install artifacts to local Maven
