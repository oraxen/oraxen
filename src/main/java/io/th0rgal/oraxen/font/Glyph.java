...
public class Glyph {
    ...
    private boolean tabcompleteUnicode;
    ...
    public Glyph(final String glyphName, final ConfigurationSection glyphSection, int newCode) {
        ...
        if (glyphSection.isConfigurationSection("chat")) {
            ...
            tabcompleteUnicode = chatSection.getBoolean("tabcomplete_unicode", true);
    ...
    public boolean hasTabCompletionWithUnicodes() {
        return tabcompleteUnicode;
    }
