package io.th0rgal.oraxen.mechanics.provided.gameplay.mushroomstem.directional;
...
public class DirectionalBlock {
    ...
    private int getDirectionVariation(String id) {
        return ((MushroomStemMechanic) MushroomStemMechanicFactory.getInstance().getMechanic(id)).getCustomVariation();
    }

    public String getDirectionalModel(MushroomStemMechanic mechanic) {
