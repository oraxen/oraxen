package io.th0rgal.oraxen.mechanics.provided.gameplay.mushroomstem.farmblock;
...
import static io.th0rgal.oraxen.mechanics.provided.gameplay.mushroomstem.MushroomStemMechanic.FARMBLOCK_KEY;
                        ...
                        if (mechanic != null && mechanic.hasDryout()) {
                            ...
                            if (customBlockData.has(FARMBLOCK_KEY, PersistentDataType.INTEGER)) {
                                ...
                                if (farmMechanic.getDryoutTime() - moistTimerRemain <= 0) {
                                    MushroomStemMechanicFactory.setBlockModel(block, farmMechanic.getFarmBlock());
                                ...
                                if (isWet || rainingAtBlock) {
                                    MushroomStemMechanicFactory.setBlockModel(block, farmMechanic.getMoistFarmBlock());
                                    customBlockData.set(FARMBLOCK_KEY, PersistentDataType.INTEGER, 0);
                                }
                            }
                        }
