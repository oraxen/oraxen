...
public final class Translations {
	...
	public static final class TranslationManager {
		...
		private final File folder = new File("plugins//Snowypine//translation");
		...
		public TranslationManager reloadCatch() {
			try {
				...
				Snowypine.getCurrentLogger().log(e);
			}
			return this;
		}
		...
		public TranslationManager reload() throws IOException {
			...
			Bukkit.getPluginManager().callEvent(new SnowyTranslationEvent(this, fallback));
			...
			LanguageProvider.DEFAULT_LANGUAGE.setName(language.check("default", "Default"));
