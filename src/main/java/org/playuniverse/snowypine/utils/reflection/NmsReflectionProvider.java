...
import org.playuniverse.snowypine.utils.reflection.version.MinecraftVersion;
import org.playuniverse.snowypine.utils.reflection.version.ServerVersion;

import java.util.Optional;
import java.util.function.Consumer;

public class NmsReflectionProvider {
    ...
    public static final NmsReflectionProvider SNOWYPINE = new NmsReflectionProvider(Reflections::setup);
    ...
    public NmsReflectionProvider() {
        this((Consumer<NmsReflectionProvider>) null);
    }

    public NmsReflectionProvider(Consumer<NmsReflectionProvider> setup) {
        this(new ReflectCache(), setup);
    }

    public NmsReflectionProvider(ReflectCache cache) {
        this(cache, null);
    }

    public NmsReflectionProvider(ReflectCache cache, Consumer<NmsReflectionProvider> setup) {
        this.cache = cache;
