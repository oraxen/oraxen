...
/**
 * NMS Handler for Spigot 1.20.6 (uses Spigot mappings).
 * This is a simplified implementation. For full feature support, use Paper.
 */
public class NMSHandler implements io.th0rgal.oraxen.nms.NMSHandler {
    ...
    public NMSHandler() {
        this.glyphHandler = new io.th0rgal.oraxen.nms.v1_20_R4_spigot.GlyphHandler();
        if (!warningLogged) {
            Logs.logWarning("Spigot 1.20.6 detected. Some features are limited compared to Paper.");
            Logs.logWarning("For full feature support, consider using Paper 1.20.6+");
            warningLogged = true;
        }
    }
    ...
    public ItemStack copyItemNBTTags(ItemStack oldItem, ItemStack newItem) {
        // NBT copying requires NMS with correct Spigot-mapped method names
        // Return newItem unchanged for Spigot compatibility
        return newItem;
    }
