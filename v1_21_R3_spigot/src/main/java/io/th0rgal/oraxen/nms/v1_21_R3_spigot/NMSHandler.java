package io.th0rgal.oraxen.nms.v1_21_R3_spigot;
...
public class NMSHandler implements io.th0rgal.oraxen.nms.NMSHandler {
    ...
    public NMSHandler() {
        this.glyphHandler = new io.th0rgal.oraxen.nms.v1_21_R3_spigot.GlyphHandler();
        if (!warningLogged) {
            Logs.logWarning("Spigot 1.21.4 detected. Some features are limited compared to Paper.");
            Logs.logWarning("For full feature support, consider using Paper 1.21.4+");
            warningLogged = true;
        }
    }
