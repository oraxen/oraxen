...
// This module is for Spigot servers, while v1_21_R3 is for Paper servers (Mojang-mapped)
// Requires: Run Spigot BuildTools for 1.21.4 to install artifacts to local Maven
