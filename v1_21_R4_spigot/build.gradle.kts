...
// This module is for Spigot servers, while v1_21_R4 is for Paper servers (Mojang-mapped)
// Requires: Run Spigot BuildTools for 1.21.5 to install artifacts to local Maven
