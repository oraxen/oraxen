...
// This module is for Spigot servers, while v1_21_R6_old is for Paper servers (Mojang-mapped)
// Requires: Run Spigot BuildTools for 1.21.10 to install artifacts to local Maven
