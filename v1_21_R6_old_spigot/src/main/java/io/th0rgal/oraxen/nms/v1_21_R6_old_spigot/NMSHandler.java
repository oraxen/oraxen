package io.th0rgal.oraxen.nms.v1_21_R6_old_spigot;
...
public class NMSHandler implements io.th0rgal.oraxen.nms.NMSHandler {
    ...
    public NMSHandler() {
        this.glyphHandler = new io.th0rgal.oraxen.nms.v1_21_R6_old_spigot.GlyphHandler();
        if (!warningLogged) {
            Logs.logWarning("Spigot 1.21.10 detected. Some features are limited compared to Paper.");
            Logs.logWarning("For full feature support, consider using Paper 1.21.10+");
            warningLogged = true;
        }
    }
